...
export const createReview = async (req, res) => {
  try {
    ...
    // Validate the session exists and is completed, and user is a participant
    if (sessionId) {
    ...
    // Instead of findByIdAndUpdate, we fetch and save to trigger hooks and level checks
    const revieweeUser = await userModel.findById(revieweeId);
    ...
    await revieweeUser.save({ validateBeforeSave: false });
